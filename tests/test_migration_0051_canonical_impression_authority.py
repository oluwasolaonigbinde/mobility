"""Migration 0051: one deterministic authority row per trip/methodology."""
...
_migration_path = (
    Path(__file__).parents[1] / "alembic/versions/0051_canonical_impression_authority.py"
)
_migration_spec = importlib.util.spec_from_file_location("migration_0051", _migration_path)
...
async def create_temporary_database(database_url: str) -> str:
    ...
    database_name = f"test_0051_authority_{uuid4().hex}"
