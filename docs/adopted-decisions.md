...
| Q31 | Privacy/consent/retention sign-off | **OPEN** | Client must name the legal/compliance approver. Retention stays configurable (§24); consent wording is content. | **Gates**: live data collection at go-live and Q11 segment-export activation. Build proceeds; the export capability ships disabled. |
