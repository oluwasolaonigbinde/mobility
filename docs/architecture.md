...
> closed and RM2 is half closed, while RM6 remains open. The other rows are
...
- **Pilot driver client (Q10/D18):** a production-hardened installable PWA with
  ...
  runtime claim) and R14-A itself stays open until representative
  Android/iPhone probe evidence is recorded. W4 must prove standalone
