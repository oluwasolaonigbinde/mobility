...
**Current capacity assignment:** `R22, R57`
...
and release-contract surfaces. R22 and R57 have disjoint write and test leases;
...
**Current checkpoint:** `PKG-10 / R22` — R02 is accepted at `09c0b17`, R47 at
...
`eb59a84`, R52 at `cab745c`, R20 at `d8cd891`, R21 at `ee43b10`, and R55 at `662077a`; R22 and R57 are the assigned
disjoint writers.
...
| R22 | MON-004, MON-007, MON-009 | R20, R21 | ACTIVE | PASS — R22-P | PENDING | CP-MONEY PENDING |
