...
**Current capacity assignment:** `R13, R24, R34`
**Current capacity justification:** `R13` owns the observability parser availability correction, `R24` owns the billing budget-resume epoch service/tests, and `R34` owns the disjoint trip/offline evidence protocol plus the serialized migration/generated-contract/configuration lane. R02 and R09 remain temporarily conflict-held behind R13. Shared fixtures and this file remain controller-serialized.
...
**Current checkpoint:** `PKG-10 / R13` — the final observability availability
correction runs alongside the commercial epoch and offline protocol lanes.
