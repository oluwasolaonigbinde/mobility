"""Create identity, organization, membership, and audit tables.

Revision ID: 0002_identity_and_organizations
...
revision: str = "0002_identity_and_organizations"
...
def upgrade() -> None:
    op.create_table(
        ...
        sa.CheckConstraint("role IN ('admin', 'advertiser', 'driver')", name="ck_users_role"),
        sa.CheckConstraint(
