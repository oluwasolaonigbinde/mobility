...
| R28 | CAM-001 | READY-REVIEW | campaign opener | D18/Q15 already makes the administrator the final activation actor | re-review the plan against existing authority, then implement only the demonstrated activation defect |
