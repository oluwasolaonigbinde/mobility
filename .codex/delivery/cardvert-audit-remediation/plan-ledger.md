...
| R13 | SEC-001, PRV-008 | REVIEW | sensitive-metadata opener | R13-P; attempts 1-6 reviews FIX; attempt-7 frozen `16f1b2b8...` | repeat independent Sol/high R13-M/SEC/PRV/CP-PRIVACY review |
...
| R24 | COM-002 | ACTIVE | R08, R23 | R24-P; attempt-1 review FIX | establish causally ordered resume epoch and complete money-path evidence |
...
Implementation writers reserved/active: **2 / 3**, reserved S09/R24 correction
and active S12/R34. R13 is frozen for read-only admission review. R02 remains temporarily
