          ...
          <div className="border-edge mt-4 rounded-lg border p-4">
            <div className="flex flex-wrap items-center justify-between gap-3">
              <div>
                ...
                <p className="micro text-muted mt-1">
                  {formatMoney(latest.net_amount, latest.currency)} net +{" "}
                  {formatMoney(latest.tax_amount, latest.currency)} VAT ·{" "}
                  {formatMoney(latest.gross_amount, latest.currency)} total
                </p>
              </div>
