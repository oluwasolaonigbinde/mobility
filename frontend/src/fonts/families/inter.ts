...
/**
 * Inter — vendored from Google Fonts, self-hosted, no build-time or runtime
...
const interCyrillicExt = localFont({
  src: [
    { path: "../google/Inter-cyrillic-ext.woff2" },
  ],
  weight: "100 900",
  style: "normal",
  display: "swap",
...
const interCyrillic = localFont({
  src: [
    { path: "../google/Inter-cyrillic.woff2" },
  ],
  weight: "100 900",
  style: "normal",
  display: "swap",
...
const interGreekExt = localFont({
  src: [
    { path: "../google/Inter-greek-ext.woff2" },
  ],
  weight: "100 900",
  style: "normal",
  display: "swap",
...
const interVietnamese = localFont({
  src: [
    { path: "../google/Inter-vietnamese.woff2" },
  ],
  weight: "100 900",
  style: "normal",
  display: "swap",
...
const interLatinExt = localFont({
  src: [
    { path: "../google/Inter-latin-ext.woff2" },
  ],
  weight: "100 900",
  style: "normal",
  display: "swap",
...
/** Font-family chain for the `Inter` faces, in Google's own subset order. */
export const inter = [interCyrillicExt, interCyrillic, interGreekExt, interGreek, interVietnamese, interLatinExt, interLatin]
