...
/**
 * Fraunces — vendored from Google Fonts, self-hosted, no build-time or runtime
 ...
 * Only the terminal latin face carries the metric-adjusted fallback (Times New Roman),
...
const frauncesVietnamese = localFont({
  src: [
    { path: "../google/Fraunces-vietnamese.woff2" },
  ],
  weight: "100 900",
  style: "normal",
  display: "swap",
...
const frauncesLatinExt = localFont({
  src: [
    { path: "../google/Fraunces-latin-ext.woff2" },
  ],
  weight: "100 900",
  style: "normal",
  display: "swap",
...
const frauncesLatin = localFont({
  src: [
    { path: "../google/Fraunces-latin.woff2" },
  ],
  weight: "100 900",
  style: "normal",
  display: "swap",
...
/** Font-family chain for the `Fraunces` faces, in Google's own subset order. */
export const fraunces = [frauncesVietnamese, frauncesLatinExt, frauncesLatin]
