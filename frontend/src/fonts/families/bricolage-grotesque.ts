...
/**
 * Bricolage Grotesque — vendored from Google Fonts, self-hosted, no build-time or runtime
...
const bricolageVietnamese = localFont({
  src: [
    { path: "../google/BricolageGrotesque-vietnamese.woff2" },
  ],
  weight: "200 800",
  style: "normal",
  display: "swap",
...
const bricolageLatinExt = localFont({
  src: [
    { path: "../google/BricolageGrotesque-latin-ext.woff2" },
  ],
  weight: "200 800",
  style: "normal",
  display: "swap",
...
const bricolageLatin = localFont({
  src: [
    { path: "../google/BricolageGrotesque-latin.woff2" },
  ],
  weight: "200 800",
  style: "normal",
  display: "swap",
...
/** Font-family chain for the `Bricolage Grotesque` faces, in Google's own subset order. */
export const bricolage = [bricolageVietnamese, bricolageLatinExt, bricolageLatin]
